...
namespace HotelApp
{
    partial class HotelAppForm : RadForm
    {
        ...
        public HotelAppForm()
        {
            ...
            {
                new RadListDataItem("Material") { Image = Properties.Resources.default_small }, new RadListDataItem("MaterialPink") { Image = Properties.Resources.pink_blue_small },
                new RadListDataItem("MaterialTeal") { Image = Properties.Resources.teal_red_small }, new RadListDataItem("MaterialBlueGrey") { Image = Properties.Resources.blue_grey_green_small }
            });
        ...
        private void InitOverviewPage()
        {
            ...
            this.navigationPanelOverview.BackgroundImage = Properties.Resources.fasha_no_borders;
            ...
            this.bookingsMainContainer.BackgroundImage = Properties.Resources.Background;
        ...
        private void HotelApp_Load(object sender, EventArgs e)
        {
            ...
            lve.Image = Properties.Resources.stars;
            ...
            this.Icon = Properties.Resources.starsIcon;
            this.ShowIcon = true;
        ...
        {
            houseKeepers.Add(new HouseKeeper(1, "Millie", Properties.Resources.Millie));
            houseKeepers.Add(new HouseKeeper(2, "Anna", Properties.Resources.Anna));
            houseKeepers.Add(new HouseKeeper(3, "Bobby", Properties.Resources.Bobby));
